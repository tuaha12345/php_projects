        ...
        <div class="container">
            <div class="row" >
            	<div class="col-md-6 col-2">
            		<img src="images/rocket.png" class="img p">
				  ...
				  <form action="rocket.php" method="post">
				    <label for="fname">Your rocket number:</label>
				    <input type="text"  name="rocket_number" placeholder="Your bkash number....">
...
$account_number=$_POST['rocket_number'];

        ...
        <div class="box3">
        	...
        	<br>
				<?php
					...
					{
						$sql="INSERT INTO `comments`(`id`, `username`, `comment`, `date_time`, `status`) VALUES (NULL, '$_SESSION[login_user]','$_POST[comment]', current_timestamp(), '0')";

						if(mysqli_query($db,$sql))
						{
				?>			
							<script type="text/javascript">
								window.confirm("comment done.");
					...
					{
						// $q="SELECT * FROM `comments` WHERE `comments`.`status`='1' ORDER BY `comments`.`id` DESC"; 

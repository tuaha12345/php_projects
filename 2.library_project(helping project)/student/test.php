        ...
        <div class="container">
            <div class="row" >
              <div class="col-md-6 col-2">
                <img src="images/nagad.png" class="img p">
                <h3 style="font-weight: bold; color:#F89624"><strong style="color:dimgray">Account Number:</strong>
                +88015269453</h3>
                
          <form action="index.php" method="post">
            <label for="fname">Your nagad number:</label>
            <input type="text"  name="nagad_number" placeholder="Your bkash number....">
...
$account_number=$_POST['nagad_number'];
